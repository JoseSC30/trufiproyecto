<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('socio') }}
            {{ Form::text('socio', $multa->socio, ['class' => 'form-control' . ($errors->has('socio') ? ' is-invalid' : ''), 'placeholder' => 'Socio']) }}
            {!! $errors->first('socio', '<div class="invalid-feedback">:message</div>') !!}
        </div>

        <div class="form-group">
            {{ Form::label('empleado') }}
            {{ Form::text('empleado', $multa->empleado, ['class' => 'form-control' . ($errors->has('empleado') ? ' is-invalid' : ''), 'placeholder' => 'Empleado']) }}
